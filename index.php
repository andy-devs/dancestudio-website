...
<html lang="ru">
	<head>
		...
		<script type="text/javascript">
			!(function () {
				...
				(t.type = 'text/javascript'),
					...
					(t.onload = function () {
						VK.Retargeting.Init('VK-RTRG-1206991-d4Crw'), VK.Retargeting.Hit();
					}),
		...
		<noscript
			><img
				src="https://vk.com/rtrg?p=VK-RTRG-1206991-d4Crw"
				...
				<div class="info__tabs__body">
					<div class="info__tabs__body-item info__tab__styles _active">
						...
						<a class="info__tab__styles-item">
							...
							<p class="info__tab__styles-item__text">7-11|10+|12+|14+ лет</p>
						</a>
						<div class="modal-styles">
							<div class="modal-content-styles">
								<span class="close-styles">&times;</span>
						...
						<a class="info__tab__styles-item">
							...
							<p class="info__tab__styles-item__text">13+ лет</p>
						</a>
						<div class="modal-styles">
							<div class="modal-content-styles">
								<span class="close-styles">&times;</span>
								<div class="modal-styles__block">
									...
									<div class="modal-styles__block-charts">
										...
										<p class="modal-styles__block-charts__item-text">13+ лет</p>
										<h4 class="modal-styles__block-charts__item-head">
											Доступные филиалы:
										</h4>
										<p class="modal-styles__block-charts__item-text">
						...
						<a class="info__tab__styles-item">
							<h3 class="info__tab__styles-item__head">EXPERIMENTAL</h3>
						...
						<div class="modal-styles">
							<div class="modal-content-styles">
								...
								<div class="modal-styles__block">
									<div class="modal-styles__block-info">
										<h4 class="modal-styles__block-info__name">EXPERIMENTAL</h4>
										<p class="modal-styles__block-info__desc">
											Направление, в рамках которого каждое движение является
											самовыражением! Представьте, сколько эмоций, слов и
											настроений может передать ваше тело через танец!
										</p>
									</div>
									<div class="modal-styles__block-charts">
										<h4 class="modal-styles__block-charts__item-head">
							...
							<div class="modal-content-styles">
								...
								<div class="modal-styles__block">
									...
									<div class="modal-styles__block-charts">
										...
										<p class="modal-styles__block-charts__item-text">16+ лет</p>
										<h4 class="modal-styles__block-charts__item-head">
											Доступные филиалы:
										</h4>
										<p class="modal-styles__block-charts__item-text">
						...
						<div class="modal-styles">
							<div class="modal-content-styles">
								...
								<div class="modal-styles__block">
									<div class="modal-styles__block-info">
										<h4 class="modal-styles__block-info__name">CONTEMPORARY</h4>
										<p class="modal-styles__block-info__desc">
											Разновидность современной хореографии с сочетанием
											классической базы и импровизации, благодаря которому
											каждый ученик сможет обрести спокойствие и внутреннюю
											уверенность, прочувствовать своё тело
										</p>
									</div>
									<div class="modal-styles__block-charts">
										<h4 class="modal-styles__block-charts__item-head">
						...
						<div class="modal-styles">
							<div class="modal-content-styles">
								...
								<div class="modal-styles__block">
									<div class="modal-styles__block-info">
										<h4 class="modal-styles__block-info__name">K-POP</h4>
										<p class="modal-styles__block-info__desc">
											Популярное танцевальное направление, которое заключается в
											изучении хореографии известных k-pop исполнителей
										</p>
									</div>
									<div class="modal-styles__block-charts">
										<h4 class="modal-styles__block-charts__item-head">
					...
					<div class="info__tab__teachers info__tabs__body-item">
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">Директор студии</p>
						</a>
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">
								Hip-Hop 6-8 лет | Choreo Girls 13+
							</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">Shuffle 6+|8+</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
						...
						<a class="info__tab__teachers-item">
							<img
								class="info__tab__teachers-item__photo"
								src="./images/shystak.jpg"
								alt=""
							/>
							<h3 class="info__tab__teachers-item__name">Лиза Шустякова</h3>
							...
							<div class="modal-content-teachers">
								...
								<div class="modal-teachers__block">
									...
									<div class="modal-teachers__block-info">
										...
										<a
											href="https://www.instagram.com/lizavettaas/"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											lizavettaas
										...
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Посещение мастер-классов:</span
											>
											Polly Oricci(2), Keks Oricci(2), Shipa West, Ivan West(2),
											Anchi West, Zoe West, Leo 007, Julieta 007, Юра
											Бражников(2), Pony Gorgeous Gucci, Serge Ebony и MJ
											Revlon, Nikita Revlon, Coco Revlon, Katarina Ebony, Yera
											007, Darya Yanson, Jenya Extravaganza, Ramon, Игорь Котов,
											Ира Подшивалова
										</p>
									</div>
								</div>
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">
								Hip-Hop 6-8 лет | Ритмика 3-5 лет
							</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
						...
						<a class="info__tab__teachers-item">
							<img
								class="info__tab__teachers-item__photo"
								src="./images/pchelkina-p.jpg"
								alt=""
							/>
							<h3 class="info__tab__teachers-item__name">Настя Пчёлкина</h3>
						...
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								...
								<div class="modal-teachers__block">
									<div class="modal-teachers__block-photo">
										<img src="./images/pchelkina-f.jpg" alt="" />
									</div>
									<div class="modal-teachers__block-info">
										<h4 class="modal-teachers__block-info__name">
											Настя Пчёлкина
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">Choreo 13+ лет</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
						...
						<a class="info__tab__teachers-item">
							<img
								class="info__tab__teachers-item__photo"
								src="./images/mikaelan.jpeg"
								alt=""
							/>
							<h3 class="info__tab__teachers-item__name">Карина Микаелян</h3>
						...
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								...
								<div class="modal-teachers__block">
									<div class="modal-teachers__block-photo">
										<img src="./images/mikaelan.jpeg" alt="" />
									</div>
									<div class="modal-teachers__block-info">
										<h4 class="modal-teachers__block-info__name">
											Карина Микаелян
										...
										<a
											href="https://www.instagram.com/mik.kaa__/"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											mik.kaa__
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">Contemporary 14+</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">
								Hip-Hop 6-10 лет | Hip-Hop 10-15 лет | Hip-Hop 12-15 лет
							</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">Hip-Hop 10+</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
						...
						<a class="info__tab__teachers-item">
							<img
								class="info__tab__teachers-item__photo"
								src="./images/zarya.jpg"
								alt=""
							/>
							<h3 class="info__tab__teachers-item__name">Настя Заря</h3>
							<p class="info__tab__teachers-item__group">Dancehall 7-11 лет</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
								<div class="modal-teachers__block">
									<div class="modal-teachers__block-photo">
										<img src="./images/zarya.jpg" alt="" />
									</div>
									<div class="modal-teachers__block-info">
										<h4 class="modal-teachers__block-info__name">Настя Заря</h4>
										<a
											href="https://www.instagram.com/zarya_anastasya/"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											zarya_anastasya
										...
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Посещение мастер-классов:</span
											>
											Katys, nasty, apilatof, Кирилл Захаров, Александр Царёв,
											Катя Реймерс, Максим Тхай, pyshka malyshka, anette, Рустам
											Лукин, Юлия Мурашко, Кирилл Зуб, макс бон, Артём
											Нефедоров, Дмитрий Черкозьянов, Илья Рысин, Олег Клевакин,
											Анна Тарасенко, Катя mighty, Василий Волошин, Лев
											Ведерников и др
										</p>
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">
								Ритмика 3-5 лет | Современная хореография для детей 5-7 лет
							</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								...
								<div class="modal-teachers__block">
									...
									<div class="modal-teachers__block-info">
										...
										<div class="modal-teachers__block-info__groups">
											...
											<div class="modal-teachers__block-info__groups-block">
												<p>Современная хореография для детей 5-7 лет</p>
												<p>ПН/СР/ПТ 18:00-19:00</p>
											</div>
										</div>
										<p class="modal-teachers__block-info__desc">
						...
						<a class="info__tab__teachers-item">
							<img
								class="info__tab__teachers-item__photo"
								src="./images/kozhinaa.jpg"
								alt=""
							/>
							<h3 class="info__tab__teachers-item__name">Кристина Кожина</h3>
							<p class="info__tab__teachers-item__group">High heels 16+</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
								<div class="modal-teachers__block">
									<div class="modal-teachers__block-photo">
										<img src="./images/kozhinaa.jpg" alt="" />
									</div>
									<div class="modal-teachers__block-info">
										<h4 class="modal-teachers__block-info__name">
											Кристина Кожина
										...
										<a
											href="https://www.instagram.com/_kristinakozhina_/"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											_kristinakozhina_
										...
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Посещение мастер-классов:</span
											>
											Алёны Бончинче, от Сергея Епанчинцева, Максима и Данила
											Voodoo, dancehall female от Анны Эйналовой, классы в
											Питере по high heels от Кравчик, Соболевой, Брагиной,
											Коптяевой, Годжиевой
										</p>
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Достижения:</span
											>
											1 место по вогу в номинации Runway, 3 место в номинации
											Femme
										</p>
									</div>
								</div>
						...
						<a class="info__tab__teachers-item">
							<img
								class="info__tab__teachers-item__photo"
								src="./images/sidorova.jpg"
								alt=""
							/>
							<h3 class="info__tab__teachers-item__name">Лера Сидорова</h3>
							<p class="info__tab__teachers-item__group">Strip 16+</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
								<div class="modal-teachers__block">
									<div class="modal-teachers__block-photo">
										<img src="./images/sidorova.jpg" alt="" />
									</div>
									<div class="modal-teachers__block-info">
										<h4 class="modal-teachers__block-info__name">
											Лера Сидоренко
										...
										<a
											href="https://www.instagram.com/ssivaa_/"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											ssivaa_
										...
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Посещение мастер-классов:</span
											>
											Ира Подшивалова, Баина Басанова, Крис Белова, Женя
											Перминова, Игорь Котов, Антон Лушичев;
										</p>
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Достижения:</span
											>
											КМС по художественной гимнастике, Best show 2022 - 3 место
											стрип, Best Champ 2022 - 3 место команда chunks,
											победительница и финалистка Вог балов Сибири
										</p>
									</div>
								</div>
							</div>
							...
							<div class="modal-content-teachers">
								...
								<div class="modal-teachers__block">
									...
									<div class="modal-teachers__block-info">
										...
										<a
											href="https://www.instagram.com/kilotim_invrtd/"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											kilotim_invrtd
										...
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Посещение мастер-классов:</span
											>
											Всероссийские чемпионаты город Казань и Новосибирск
										</p>
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Достижения:</span
											>
											Чемпион Омской Области по Брейкингу, ТОП8 участников
											Сибирского Федерального округа по Брейк-Дансу
										</p>
									</div>
								</div>
							</div>
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">Experimental 14+</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
								<div class="modal-teachers__block">
									...
									<div class="modal-teachers__block-info">
										...
										<a
											href="https://www.instagram.com/gronmarinaaa/"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											gronmarinaaa
										...
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Посещение мастер-классов:</span
											>
											Катя Майти, Даша Майти, Полина Кошкарова, Егор Сли Аня
											Тарасенко (+прохождение её онлайн курса Formula), Ксюша
											Горячева, Хелен Мур, Мишель Битс, Кутса и Татиша Вуду,
											Даян, Олег Клевакин, Илья Хэктикдаймонд, Артём Нефедов,
											Нюта, Лёша Волков, Полина Хритинина, Кэтис
										</p>
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Достижения:</span
											>
											Баттлы Dancehall в START DANCE в 2021 - 3е место
										</p>
									</div>
								</div>
							</div>
						...
						<a class="info__tab__teachers-item">
							<img
								class="info__tab__teachers-item__photo"
								src="./images/ponomarr.jpg"
								alt=""
							/>
							<h3 class="info__tab__teachers-item__name">Саша Пономарева</h3>
							<p class="info__tab__teachers-item__group">Hip-hop 12+</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
								<div class="modal-teachers__block">
									<div class="modal-teachers__block-photo">
										<img src="./images/ponomarr.jpg" alt="" />
									</div>
									<div class="modal-teachers__block-info">
										<h4 class="modal-teachers__block-info__name">
											Саша Пономарева
										...
										<a
											href="https://www.instagram.com/_allestra_/"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											_allestra_
										...
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Посещение мастер-классов:</span
											>
											Миша Малышев, Егор Сли, Костя Квашнин, Maksimbon, Кирилл
											зуб, Артём Апилат, Полина Хритинина, Артём Нефёдов, Кирилл
											Захаров, Юля Мурашко, Максим Тхай, Рустам Лукин, Катя
											Реймерс, Александр Царёв, Гео, Аня Тарасенко, Мишель Битз,
											Карим Жусупов, Дмитрий Черкозянов, Илья Хактик Димон, Олег
											Клевакин, Никита Котомцев.
										</p>
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Достижения:</span
											>
											You champ команда Bootlace crew номинация и место: 3rd
											plase best dance show pro 16+
										</p>
									</div>
								</div>
							</div>
						...
						<a class="info__tab__teachers-item">
							<img
								class="info__tab__teachers-item__photo"
								src="./images/kiseleva.jpg"
								alt=""
							/>
							<h3 class="info__tab__teachers-item__name">Вика Киселева</h3>
							<p class="info__tab__teachers-item__group">Hip-hop 12+</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								...
								<div class="modal-teachers__block">
									<div class="modal-teachers__block-photo">
										<img src="./images/kiseleva.jpg" alt="" />
									</div>
									<div class="modal-teachers__block-info">
										<h4 class="modal-teachers__block-info__name">
											Вика Киселева
										...
										<a
											href="https://www.instagram.com/vikaa.ki /"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											vikaa.ki
										...
										<p class="modal-teachers__block-info__desc">
											<span class="modal-teachers__block-info__desc-span"
												>Достижения:</span
											>
											Art Story 1 место соло и дуэт (препод&ученик), 1 место
											дуэт, Best Champ 4 место, 1 место сибпрокач команда, 1
											место заруба чемп команда, ючемп 3 место команда, 2-3 раза
											2-е место в дх баттлах, 2-3 раза 2-е место на вог баллах,
											хип хоп баттлы
										</p>
									</div>
								</div>
						...
						<a class="info__tab__teachers-item">
							...
							<p class="info__tab__teachers-item__group">K-pop 14+</p>
						</a>
						<div class="modal-teachers">
							<div class="modal-content-teachers">
								<span class="close-teachers">&times;</span>
								<div class="modal-teachers__block">
									...
									<div class="modal-teachers__block-info">
										...
										<a
											href="https://www.instagram.com/seory/"
											class="modal-teachers__block-info__social"
										>
											<i class="fab fa-instagram"></i>
											seory
