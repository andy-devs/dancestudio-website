...
function populate(s1, s2) {
	...
	if (s1.value == '6-я Линия, 97') {
		var optionArray = [
			'hip-hop 12-15|Hip-Hop 12-15 лет - Настя',
			'hip-hop 6-8|Hip-Hop 6-8 лет - Сабина',
			'choreo girls 14+|Choreo girls 14+ - Оля',
			'dancehall 10+|Dancehall 10+ - Рената',
			'shuffle 6+|Shuffle 6+ - Алёна',
			'ritmika 3-5|Ритмика 3-5 лет - Алина',
		];
	} else if (s1.value == 'Степанца 10/2') {
		var optionArray = [
			'hip-hop 12-15|Hip-Hop 12-15 лет - Костя',
			'hip-hop 9-11|Hip-Hop 9-11 лет - Егор',
			'hip-hop 7-11|Hip-Hop 7-11 лет - Вика',
			'hip-hop 6-8|Hip-Hop 6-8 лет - Катя',
			'dancehall 7-11|Dancehall 7-11 лет - Даша',
			'dancehall 12+ продолжающие|Dancehall 12+ прод. - Даша',
			'dancehall 12+ начинающие|Dancehall 12+ начин. - Даша',
			'choreo 14+|Choreo 14+ - Никита',
			'shuffle 16+|Shuffle 16+ - Женя',
			'shuffle 6+|Shuffle 6+ - Алёна',
			'ritmika 3-5|Ритмика 3-5 лет - Яна',
			'parents|Parents Crew - Егор',
			'shuffle 6+ начинающие|Shuffle 6+ начин. - Алёна',
		];
	} else if (s1.value == '9-я Ленинская, 5') {
		var optionArray = [
			'hip-hop 8-12|Hip-Hop 8-12 лет - Миша',
			'hip-hop 6-10|Hip-Hop 6-10 лет - Полина',
			'hip-hop 5-7|Hip-Hop 5-7 лет - Кристина',
			'dancehall 14+|Dancehall 14+ - Рената',
			'dancehall 9-13|Dancehall 9-13 лет - Элина',
			'choreo 12-15|Choreo 12-15 лет - Настя',
			'choreo 14+|Choreo 14+ - Миша',
			'shuffle 8+|Shuffle 8+ - Женя',
			'ritmika 3-5|Ритмика 3-5 лет - Кристина',
			'ritmika 3-5|Ритмика 3-5 лет - Вероника',
			'electro 10+|Electro 10+ - Стас',
			'parents|Родители - Миша',
		];
	} else {
