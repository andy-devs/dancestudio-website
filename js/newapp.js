...
function populate(s1, s2) {
	...
	if (s1.value == '6-я Линия, 97') {
		var optionArray = [
			...
			'shuffle 6+|Shuffle 6+',
			'choreo girls 14+ - Катя|Choreo girls 14+ - Катя',
		...
		var optionArray = [
			...
			'hip-hop 7-11 - Вика|Hip-Hop 7-11 лет - Настя',
		...
		var optionArray = [
			'hip-hop 8-12 - Миша|Hip-Hop 8-12 лет - Миша',
			'hip-hop 6-10 - Полина|Hip-Hop 6-10 лет - Полина',
			'hip-hop 5-7 - Кристина|Hip-Hop 5-7 лет - Кристина',
			'breakdance 6+ - Аслан|Break Dance 6+ - Аслан',
			'dancehall 14+ - Рената|Dancehall 14+ - Рената',
			'dancehall 9-13 - Элина|Dancehall 9-13 лет - Элина',
